...
"$STEDGEAI_CORE_DIR/Utilities/linux/stedgeai" analyze --target stm32n6 --name "${BASE_NAME}_flash" -m "${INPUT_MODEL}" --st-neural-art "n6-flash-${BASE_NAME}@config/user_neuralart.json" --verbosity 3
