...
class TracingObject:
    ...
    def __call__(self, *args, **kwargs):
        self._cnt += 1
        # Workaround bad handling of metadata_props
        # "AttributeError: Assignment not allowed to map, or repeated field "metadata_props" in protocol message object."
        if 'metadata_props' in kwargs:
            del kwargs['metadata_props']
