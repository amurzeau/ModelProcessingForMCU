...
$STEDGEAI_CORE_DIR/Utilities/linux/stedgeai validate --target stm32n6 --name network -m ${INPUT_MODEL} --st-neural-art "n6-noextmem-noec@user_neuralart.json" --verbosity 3 --mode target -d serial:921600 -vi validation.npz
